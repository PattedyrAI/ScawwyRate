...
-- JWT-claim impersonation. Connects as the local `postgres` superuser
-- (bypasses RLS when not impersonating; can disable the signup trigger).
-- Everything is rolled back.
begin;

-- Deterministic profiles: disable the Discord signup trigger.
...
values ('11111111-1111-1111-1111-111111111111', 'authenticated', 'authenticated', 'a@test.dev'),
       ...
       ('33333333-3333-3333-3333-333333333333', 'authenticated', 'authenticated', 'c@test.dev')
...
begin
  ...
  if grp.owner_id <> '11111111-1111-1111-1111-111111111111' then
...
begin
  begin
    insert into public.group_members (group_id, user_id, role)
    values (gid, '33333333-3333-3333-3333-333333333333', 'member');
  ...
  begin
    insert into public.groups (name, invite_code, owner_id)
    values ('Evil Group', 'XYZ234', '22222222-2222-2222-2222-222222222222');
  exception when insufficient_privilege then
    ok := true;
  end;
  if not ok then
